...
// lifecycle.component.ts:43 数据没有变化
// lifecycle.component.ts:49 04ngAfterContentInit执行了---当把内容投影进组件之后调用
// lifecycle.component.ts:52 05ngAfterContentChecked执行了---每次完成被投影组件内容的变更检测之后调用
// lifecycle.component.ts:55 06 ngAfterViewInit执行了----初始化完组件视图及其子视图之后调用（dom操作放在这个里面）
// lifecycle.component.ts:58 07ngAfterViewChecked执行了----每次做完组件视图和子视图的变更检测之后调用
// core.js:28039 Angular is running in development mode. Call enableProdMode() to enable production mode.
// lifecycle.component.ts:37 03ngDoCheck执行了---检测，并在发生 Angular 无法或不愿意自己检测的变化时作出反应
// lifecycle.component.ts:43 数据没有变化
// lifecycle.component.ts:52 05ngAfterContentChecked执行了---每次完成被投影组件内容的变更检测之后调用
// lifecycle.component.ts:58 07ngAfterViewChecked执行了----每次做完组件视图和子视图的变更检测之后调用
...
// lifecycle.component.ts:58 07ngAfterViewChecked执行了----每次做完组件视图和子视图的变更检测之后调用
// lifecycle.component.ts:37 03ngDoCheck执行了---检测，并在发生 Angular 无法或不愿意自己检测的变化时作出反应
// lifecycle.component.ts:39 你从改成z
// lifecycle.component.ts:52 05ngAfterContentChecked执行了---每次完成被投影组件内容的变更检测之后调用
// lifecycle.component.ts:58 07ngAfterViewChecked执行了----每次做完组件视图和子视图的变更检测之后调用
// lifecycle.component.ts:37 03ngDoCheck执行了---检测，并在发生 Angular 无法或不愿意自己检测的变化时作出反应
// lifecycle.component.ts:39 你从z改成zz
// lifecycle.component.ts:52 05ngAfterContentChecked执行了---每次完成被投影组件内容的变更检测之后调用
// lifecycle.component.ts:58 07ngAfterViewChecked执行了----每次做完组件视图和子视图的变更检测之后调用
// lifecycle.component.ts:37 03ngDoCheck执行了---检测，并在发生 Angular 无法或不愿意自己检测的变化时作出反应
// lifecycle.component.ts:43 数据没有变化
// lifecycle.component.ts:52 05ngAfterContentChecked执行了---每次完成被投影组件内容的变更检测之后调用
// lifecycle.component.ts:58 07ngAfterViewChecked执行
